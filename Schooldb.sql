...
--
-- Table structure for table `reqhour`
--
...
--
-- Dumping data for table `reqhour`
--

LOCK TABLES `reqhour` WRITE;
/*!40000 ALTER TABLE `reqhour` DISABLE KEYS */;
/*!40000 ALTER TABLE `reqhour` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `takentraining`
--
...
--
-- Dumping data for table `takentraining`
--

LOCK TABLES `takentraining` WRITE;
/*!40000 ALTER TABLE `takentraining` DISABLE KEYS */;
/*!40000 ALTER TABLE `takentraining` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-14  9:47:00
